...
| R06 | Embedded media | Messages can include images; click opens modal fullscreen viewer. | LATER. | PARTIAL - V1 validates and renders one neutral technical image placeholder as an aspect-preserving in-transcript media card; fullscreen viewer is deferred. | Media viewer | Medium | Medium | NEW |
...
**Last reviewed functional commit:** `cc57c08845e94092c4b30be3c15b51199da97e42`
