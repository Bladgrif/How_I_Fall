...
- Full baselines are the primary runtime review evidence.
- `review/` contains lightweight copies only for tooling/reviewer access; they are not graphical regression proof.
