...
- `reading_standard.png` — облегчённая асимметричная поверхность чтения: панель диалога повторяет высоту строки, с низковесным `История / Пропуск / Авто / Быстр. сох.`.
- `reading_dialogue_125.png` — длинный диалог при поддерживаемом масштабе текста 125%: все строки внутри панели, без обрезания текста и перекрытия Quick Menu.
...
Reading-набор обновлён по полному PlayerUi graphical E2E от 2026-09-16: адаптивная высота панели диалога, namebox-пластина по ширине имени без декоративного хвоста, нейтральные состояния Quick Menu с различимым active-состоянием. Дополнительные состояния Quick Menu hover (1920), 125%-диалог и Auto (1280×720) остаются в ignored QAArtifacts. Это REVIEW CANDIDATE, не субъективное visual approval.
