...
$entryPoints = @{
    ...
    GameMenu = @{ Method = 'PlayerUiGraphicalE2ERunner.StartGameMenuAutomatedPlayMode'; Sentinel = 'player_ui_graphical_result.txt'; RequirePlayerPrefsRestore = $true; ProofFiles = @('game_menu_confirmation_1920x1080.png', 'game_menu_confirmation_1280x720.png', 'game_menu_rollback_disabled_1920x1080.png', 'game_menu_embedded_save_1920x1080.png', 'game_menu_embedded_save_1280x720.png', 'game_menu_embedded_load_1920x1080.png', 'game_menu_rollback_disabled_after_save_load_1920x1080.png', 'game_menu_rollback_enabled_1920x1080.png', 'game_menu_rollback_enabled_1280x720.png', 'gameplay_reading_after_rollback_1920x1080.png', 'game_menu_rollback_choice_enabled_1920x1080.png', 'gameplay_choice_after_rollback_1920x1080.png') }
}
