...
define config.name = _("How I Fall")
...
define gui.about = _p("""
How I Fall — мистическая подростковая визуальная новелла о соблазне, страхе, близости и выборе.

Обычная школьная жизнь начинает трескаться после странного ритуала на вечеринке. Внутри героя появляется голос, который знает его желания слишком хорошо.

Жанры: мистика, подростковая драма, романтика, детектив, психологическое напряжение.

Статус: prototype build.
""")
...
define config.save_directory = "HowIFall-1776538575"
